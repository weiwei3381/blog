...
> 📘《Efficient Node.js: A Beyond-the-Basics Guide》，2025年6月发布

![高效Node.js](https://pic1.imgdb.cn/item/68655ea358cb8da5c88a3c0c.png)

ISBN: 978-1098145194 | 240页 | PDF, EPUB | 20 MB

使用 Node.js，将您的 Web 开发技能从浏览器迁移到服务器。Node.js 是一个流行的后端框架，亚马逊、Netflix、LinkedIn 等公司超过 1000 万名开发者都在使用它。如果您熟悉 JavaScript，Samer Buna 的这本实用指南将向您展示如何有效地构建和维护最复杂的 Node.js 应用程序。

通过基于实践的、基于项目的方法，您将从关键基础知识转向高级概念，例如模块、包、事件驱动架构、流、子流程、扩展、测试、部署等等，同时专注于实践中真正重要的事情。

网盘下载：[efficient-nodejs-beyond-basics.rar](https://pan.baidu.com/s/1WAy_6M8_wWknuNzUTgbXAg)

### React之路（2025年版）

> 📘《The Road to React: The React.js in JavaScript Book (2025 Edition)》，2025年6月8日发布

![React之路](https://pic1.imgdb.cn/item/686560ca58cb8da5c88a3d4d.png)

ISBN: 978-1720043997 | 285页 | PDF, EPUB | 10 MB

《React之路：在 JavaScript 中掌握 React.js 的旅程》是一本全面、实用且简洁的 React feat.Hooks 书籍。

在《React 之路》中，你将学习 React.js 的所有基础知识以及 Hooks，并逐步构建一个功能齐全的 React 应用程序。在创建 React 应用程序的过程中，每一章都会向你介绍一个新的 React 关键功能。然而，本书不仅涵盖基础知识：本书还深入探讨了相关主题（例如，使用 TypeScript 编写 React、测试、性能优化）以及客户端和服务器端搜索等高级功能的实现。读完本书，你将拥有一个已部署且功能齐全的 React 应用程序。

网盘下载：[road-react-robin-wieruch.rar](https://pan.baidu.com/s/1ojK1mwzzgiLYXwiTwotLkA)

### 学习Vue——可重用、可组合、可扩展用户界面的核心概念和实用模式

> 📘《Learning Vue: Core Concepts and Practical Patterns for Reusable, Composable, and Scalable User Interfaces》，2024年1月发布

![学习Vue](https://pic1.imgdb.cn/item/6865672458cb8da5c88a4329.png)

ISBN: 978-1492098829 | 352页 | PDF, EPUB | 45 MB

学习 Vue.js 的核心概念，这是一个用于从零开始构建前端应用程序和界面的现代 JavaScript 框架。本书通过简洁、实用且清晰的示例，逐步指导 Web 开发人员了解 Vue.js 生态系统中的工具和库，以及如何使用它们为实际的 Web 项目创建完整的应用程序。

作者 Maya Shavin 讲解了如何使用 Vue.js 库中的各种工具创建完整的应用程序开发流程。您将学习如何使用 Pinia 架构处理组件之间的数据通信，为前端项目开发可管理的路由系统以控制应用程序流程，以及如何制作基本的动画效果以打造更佳的用户体验。
...
> 📙《Learning Python: Powerful Object-Oriented Programming, 6th Edition》，2025年6月发布

![学习Python](https://pic1.imgdb.cn/item/686565fd58cb8da5c88a42d7.png)

ISBN: 978-1098171308 | 1169页 | PDF, EPUB | 21 MB

这本实用的书籍将全面深入地介绍 Python 核心语言。本书基于作者 Mark Lutz 广受欢迎的培训课程，更新后的第六版将帮助您快速使用 Python 编写高效、高质量的代码。无论您是编程新手，还是精通其他语言的专业开发人员，这都是理想的入门之选。

这本易于理解的自学教程包含测验、练习和实用插图，可帮助您入门 Python 3.12 及目前使用的所有其他版本。它注重实用性，重点讲解您需要了解的内容，并介绍了一些在 Python 代码中越来越常见的高级语言特性。
...
> 📗《Practical Deep Learning: A Python-Based Introduction, 2nd Edition》，2025年6月发布

![实用深度学习](https://pic1.imgdb.cn/item/686558e858cb8da5c88a3992.png)

ISBN: 978-1718504202 | 584页 | EPUB | 26 MB

深度学习变得简单。经验丰富的作家兼人工智能专家 Ronald T. Kneusel 撰写了这本全面更新的《实用深度学习》，助您深入学习深度学习，无需深陷理论。本书将简要回顾基础数学和编码原理，之后您将深入实践，学习构建从图像分析到创意写作等各个领域的工作模型，并深入了解每种技术的底层工作原理。

每章都强调实践技能的培养和实验，并构建一个案例研究，该案例研究融合了你所学到的关于音频记录分类的所有知识。本书提供了可轻松运行和修改的可运行代码示例，所有代码均可在 GitHub 上免费获取。通过《实用深度学习》第二版，你将获得构建解决实际问题的真正 AI 系统所需的技能和信心。本版新增内容：涵盖计算机视觉、微调和迁移学习、定位、自监督学习、用于创作新颖图像的生成式 AI，以及用于情境学习、语义搜索和检索增强生成 (RAG) 的大型语言模型。

网盘下载：[practical-deep-learning-2nd.rar](https://pan.baidu.com/s/1v3cU9a5wIKd2-44v-Pv2-A)

### 掌握高级Excel——学习公式和函数、高级数据透视表、宏、VBA等

> 📗《Mastering Advanced Excel – With ChatGPT Integration: Learn Formulas and Functions, Advance Pivot Tables, Macros, VBA Coding, ChatGPT Integration with exercises》，2025年6月发布

![掌握高级Excel](https://pic1.imgdb.cn/item/6865685858cb8da5c88a435f.png)

ISBN: 978-9355518651 | 304页 | PDF, EPUB | 48 MB
