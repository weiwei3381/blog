...
> 从2020年8月8日开始，每天看一篇SCI论文，不用全看，至少把**摘要**、**图片**、**结论**看完，时间坚持到今年年底，即2020-12-31日截止，其中不同颜色的心形表示论文的不同重要性，重要性由高到低分别是❤️、💛、💜、💚。使用正则表达式`\[\d{1,2}[-，,]?.*?\]`可以匹配所有形如[1], [4-6], [3,5]表示的参考文献，方便统一替换。
