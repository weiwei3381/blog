...
通过大量的仿真实验验证了所提出的搜索协调和目标识别方法。对比实验表明，我们的方法在WiSAR中的性能明显优于几种替代方法。结果表明，该方法具有较高的目标检测率，并且在目标首次被无人机检测到的情况下，搜索时间更短。在最好的情况下，平均而言，所提出的方法比替代方法的性能好大约250%。与所提出方法进行比较的其他方法，只有在搜索提前开始时，才能与所提出的方法进行比较。
也就是说，当目标没有传播到远离LKP的地方。
